...
function NpcFunSanLoad_SetText(Type,Index,BtnID,SubID)
	...
	elseif SubID  == 706 then
		FirstWin_Text1:SetText(NF_L0_ZBJY10);
		FirstWin_Text1:Visible(true);
		FirstWin_Text3:SetText(NF_L0_ZBJY11);
		FirstWin_Text3:Visible(true);
		FirstWin_Text3:SetPosition(25,110);
		InputText1:Visible(true);
		InputText1:SetPosition(60,80);
		Input11:Visible(true);
		Input11:SetPosition(60,80);
		Input12:Visible(true);
		Input12:SetPosition(52,80);
		Input13:Visible(true);
		Input13:SetPosition(154,80);
	   end;
     elseif Index >= 3 then
        if SubID == 10001 then
	    FirstWin_Text1:SetText(NF_L0_ZBJY10001);
	    FirstWin_Text1:Visible(true);
	...
	if math.mod(SubID, 10) == 7 then
	   ...
	   NPCFUN:EndMessage(true);
		...
		if SubID  == 888 then
			FirstWin_Text1:SetText(NF_L0_ZBJY888);
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
		end;
	if math.mod(SubID ,100) == 0 then
	   ...
	   elseif SubID / 100 == 20 then
		...
		elseif SubID / 100 == 21 then
			FirstWin_Text1:SetText(NF_L0_ZBJY2100);
			FirstWin_Text1:Visible(true);
			FirstWin_Text1:SetPosition(25,100); 
		elseif SubID / 100 == 22 then
			FirstWin_Text1:SetText(NF_L0_ZBJY2200);
			FirstWin_Text1:Visible(true);
			FirstWin_Text1:SetPosition(25,100); 
		elseif SubID / 100 == 23 then
			FirstWin_Text1:SetText(NF_L0_ZBJY2300);
			FirstWin_Text1:Visible(true);
			FirstWin_Text1:SetPosition(25,100); 
	   end;
