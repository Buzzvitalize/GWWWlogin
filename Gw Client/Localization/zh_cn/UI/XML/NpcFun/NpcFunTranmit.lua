...
function NpcFunTranmit_SetText(Type,Index,BtnID,SubID)
	if Index == 1 then
		...
		elseif SubID == 10001 then
			FirstWin_Text1:SetText(NF_L0_10004);
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
		elseif SubID == 10002 then
			FirstWin_Text1:SetText(NF_L0_10002);
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
		elseif SubID == 10003 then
			FirstWin_Text1:SetText(NF_L0_10003);
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
		...
		elseif SubID == 11 then	--迈锡尼
			...
			Button:Visible(true);
		elseif SubID == 1088 then	--迈锡尼
			print(BtnID,SubID);
			local Button = win:GetChild("FirstWin_Button" .. BtnID);
			Button:SetText(NF_L0_214);
			Button:Visible(true);
		elseif SubID == 1089 then	--迈锡尼
			print(BtnID,SubID);
			local Button = win:GetChild("FirstWin_Button" .. BtnID);
			Button:SetText(NF_L0_215);
			Button:Visible(true);
		elseif SubID == 1090 then	--迈锡尼
			FirstWin_Text1:SetText(NF_L0_001);
			FirstWin_Text1:Visible(true);
			local Button = win:GetChild("FirstWin_Button" .. BtnID);
			Button:SetText(NF_L0_216);
			Button:Visible(true);
	...
	elseif Index == 2 then
		...
		elseif SubID == 513 then
			FirstWin_Text1:SetText(NF_L0_513);
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
			NPCFUN:NeedMessage(False);
		elseif SubID == 514 then
			FirstWin_Text1:SetText(NF_L0_514);
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
			NPCFUN:NeedMessage(False);
