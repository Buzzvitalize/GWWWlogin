...
elseif Type == NPC_FLAG_SYS_MIGRATION then    --------------抽取技能书-----------------------------------------------------------------------------
	elseif SubID % 100 == 2 then
		FirstWin_Text1:SetText(Migration7..( ( ( ( SubID - 2 ) / 100 ) - ( ( SubID - 2 ) / 100 ) % 24 ) / 24 )Migration8..( ( ( SubID - 2 ) / 100 ) % 60 )..Migration9);
		FirstWin_Text1:Visible(true);
	   FirstWin_Text1:SetPosition(45,100);
	   FirstWin_ButtonA1:SetPosition(220,500);
	   FirstWin_ButtonA1:Visible(true);
