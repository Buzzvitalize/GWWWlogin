...
Ancient_color= {r=192,g=64,b=255,a=255}
Celestial_color= {r=160,g=128,b=255,a=255}
Divine_color= {r=128,g=128,b=255,a=255}
Mythical_color= {r=102,g=204,b=255,a=255}
Ethereal_color= {r=51,g=255,b=255,a=255}

BRONZE_COLOR={r=205, g=127, b=50, a=255}
SILVER_COLOR={r=255, g=255, b=255, a=255}
GOLD_COLOR={r=255 , g=153 , b=0,a=255}
PLATINUM_COLOR={r=22, g=217, b=255, a=255}
MITHRIL_COLOR={r=116, g=219, b=171, a=255}
ORICHALCUM_COLOR={r=190, g=91, b=252, a=255}
ADAMANTIUM_COLOR={r=226, g=110, b=161, a=255}

WATER_COLOR={r=160,g=128,b=255,a=255}
FIRE_COLOR={r=255, g=0  , b=0  , a=255}
