...
function HelpSystem_OnClickAutoBtn()
	...
	--推荐人系统
function HelpSystem_OnClickTuijianBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(7).static_text);
end

--星座系统
function HelpSystem_OnClickConstellationBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(8).static_text);
end

--圣衣系统
function HelpSystem_OnClickStoleBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(9).static_text);
end

-- added --
function HelpSystem_OnClickBronzeBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(12).static_text);
end
function HelpSystem_OnClickSilverBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(13).static_text);
end
function HelpSystem_OnClickGoldBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(14).static_text);
end
function HelpSystem_OnClickPlatinumBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(15).static_text);
end
function HelpSystem_OnClickMithrilBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(16).static_text);
end
function HelpSystem_OnClickOrichalcumBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(17).static_text);
end
function HelpSystem_OnClickAdamantiumBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(18).static_text);
end



--圣石系统
function HelpSystem_OnClickStoneBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(10).static_text);
end

function HelpSystem_OnClickFireSpiritBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(19).static_text);
end
function HelpSystem_OnClickWaterSpiritBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(20).static_text);
end

--坐骑系统
function HelpSystem_OnClickCreateBtn()
	HelpSystem_Initcontainer1();
	cont1_text:SetText(Get_HelpSystem_Cofig(11).static_text);
end
...
--宠物系统
function HelpSystem_OnClickPetsystemBtn1()
	HelpSystem_Initcontainer1();


	cont1_btn1:Visible(true);
	cont1_btn1:SetText(HSP_L0_74);

	cont1_btn2:Visible(true);
	cont1_btn2:SetText(HSP_L0_75);
...
function HelpSystem_OnClickPetsystemBtn2()
	HelpSystem_Initcontainer1();

	cont1_btn1:Visible(true);
	cont1_btn1:SetText(HSP_L0_76);

	cont1_btn2:Visible(true);
	cont1_btn2:SetText(HSP_L0_77);

	cont1_btn3:Visible(true);
	cont1_btn3:SetText(HSP_L0_78);

	cont1_btn4:Visible(true);
	cont1_btn4:SetText(HSP_L0_79);

	cont1_btn5:Visible(true);
	cont1_btn5:SetText(HSP_L0_80);

    container1:Auto();
	func_select_flags = 6;
end
--生活技能
function HelpSystem_OnClickLiveSkillBtn()
	HelpSystem_Initcontainer1();

	cont1_btn1:Visible(true);
	cont1_btn1:SetText(HSP_L0_81);

	cont1_btn2:Visible(true);
	cont1_btn2:SetText(HSP_L0_82);


	cont1_btn3:Visible(true);
	cont1_btn3:SetText(HSP_L0_83);
...
function HelpSystem_OnClickBtn1()
	...
	elseif func_select_flags == 5 then
		HelpSystem_ReadSkillInfo(401)
    elseif func_select_flags == 6 then
		HelpSystem_ReadSkillInfo(501)
	elseif func_select_flags == 7 then
		HelpSystem_ReadSkillInfo(601)
	end
	--返回上一页按钮
...
function HelpSystem_OnClickBtn2()
	...
	elseif func_select_flags == 5 then
		HelpSystem_ReadSkillInfo(402)
	elseif func_select_flags == 6 then
		HelpSystem_ReadSkillInfo(502)
	elseif func_select_flags == 7 then
		HelpSystem_ReadSkillInfo(602)
	end
	--返回上一页按钮
	HelpSystem_cont1FirstTextAuto();
...
function HelpSystem_OnClickBtn3()
	...
	elseif func_select_flags == 6 then
	   HelpSystem_ReadSkillInfo(503)
	elseif func_select_flags == 7 then
	   HelpSystem_ReadSkillInfo(603)
	end
	--返回上一页按钮
	HelpSystem_cont1FirstTextAuto();
...
function HelpSystem_BackFirstBtn()
	...
	elseif func_select_flags == 5 then
		HelpSystem_OnClickPetsystemBtn1();
	elseif func_select_flags == 6 then
		HelpSystem_OnClickPetsystemBtn2();
	elseif func_select_flags == 7 then
		HelpSystem_OnClickLiveSkillBtn();
	end
