...
function NpcFunVocation_SetText(Type,Index,BtnID,SubID)
	...
	elseif Index == 2 then	--服务器提示消息---------------------
		...
		elseif SubID == 140 then
           	FirstWin_ItemBtn1:Visible(true);
			FirstWin_ItemBtn1:SetPosition(25,50);
			FirstWin_Text1:SetText(NF_V0_V129);
			FirstWin_Text1:Visible(true);
		elseif SubID == 141 then
	        FirstWin_ItemBtn2:Visible(true);
          	FirstWin_ItemBtn2:SetPosition(25,120);
			FirstWin_Text2:SetText(NF_V0_V130);
			FirstWin_Text2:Visible(true);
			FirstWin_Text2:SetPosition(25,100);
		...
		elseif SubID == 142 then
			...
			Button:SetText(NF_L0_CY001);
			Button:Visible(true);
			FirstWin_Text3:SetText(NF_V0_V128);
			FirstWin_Text3:Visible(true);
			FirstWin_Text3:SetPosition(25,170);
	...
	elseif Index == 3 then	--服务器提示消息---------------------
		...
		elseif SubID == 1132 then
			...
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
		elseif SubID == 1133 then
			FirstWin_Text1:SetText(NF_L0_CY008);
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
		...
		elseif SubID == 164 then
			...
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
		elseif SubID == 165 then
			FirstWin_Text1:SetText(NF_V0_V151);
			FirstWin_Text1:Visible(true);
		elseif SubID == 166 then
			FirstWin_Text1:SetText(NF_V0_V152);
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
		elseif SubID == 167 then
			FirstWin_Text1:SetText(NF_V0_V153);
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
		elseif SubID == 168 then
			FirstWin_Text1:SetText(NF_V0_V154);
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
		elseif SubID == 169 then
			FirstWin_Text1:SetText(NF_V0_V155);
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
		...
		elseif SubID == 302 then
			FirstWin_Text1:SetText(NF_L0_Y150);
			FirstWin_Text1:Visible(true);
			NPCFUN:EndMessage(true);
		end;
	end;
